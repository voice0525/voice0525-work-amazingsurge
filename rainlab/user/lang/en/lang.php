...
return [
    ...
    'groups' => [
        ...
        'activating' => 'Activating...',
        'activate_warning_title' => 'Group not activated!',
        'activate_warning_desc' => 'This group has not been activated and will be unable to sign in.',
        'activate_confirm' => 'Do you really want to activate this group?',
        'active_manually' => 'Activate this group manually',
        ...
        'returnlist' => 'Return to Groups list',
        'delete_selected_empty' => 'There are no selected users to delete.',
        'delete_selected_confirm' => 'Delete the selected users?',
        'delete_selected_success' => 'Successfully deleted the selected users.',
    ]
