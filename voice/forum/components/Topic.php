...
class Topic extends ComponentBase
{
    ...
    /**
     * @var Voice\Forum\Models\Topic Topic cache
     */
    ...
    {
        return [
            'name'        => 'voice.forum::lang.topicpage.name',
            'description' => 'voice.forum::lang.topicpage.desc'
        ];
    }
    ...
    public function defineProperties()
    {
        return [
            'slug' => [
                'title'       => 'voice.forum::lang.topicpage.slug_name',
                'description' => 'voice.forum::lang.topicpage.slug_desc',
                'default'     => '{{ :slug }}',
                'type'        => 'string',
            ],
            'postsPerPage' => [
                'title'       => 'voice.forum::lang.topicpage.pagination_name',
                'default'     => '20',
                'type'        => 'string',
            ],
            'memberPage' => [
            ...
            'channelPage' => [
                'title'       => 'voice.forum::lang.topicpage.channel_title',
                'description' => 'voice.forum::lang.topicpage.channel_desc',
                'type'        => 'dropdown',
                'group'       => 'Links',
            ],
        ];
    ...
    protected function handleOptOutLinks()
    {
        ...
        if ($action == 'unsubscribe' && $member->user) {
            MailBlocker::addBlock('voice.forum::mail.topic_reply', $member->user);
    ...
    public function onCreate()
    {
        try {
             ...
             * Extensbility
             */
            Event::fire('voice.forum.topic.create', [$this, $topic, $topicUrl]);
    ...
    public function onPost()
    {
        try {
             ...
             * Extensbility
             */
            Event::fire('voice.forum.topic.post', [$this, $post, $postUrl]);
