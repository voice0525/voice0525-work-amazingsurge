...
class EmbedChannel extends ComponentBase
{
    ...
    {
        return [
            'name'        => 'voice.forum::lang.embedch.channel_name',
            'description' => 'voice.forum::lang.embedch.channel_self_desc'
        ];
    }
    ...
    public function defineProperties()
    {
        return [
            'embedCode' => [
                'title'             => 'voice.forum::lang.embedch.embed_title',
                'description'       => 'voice.forum::lang.embedch.embed_desc',
                'type'              => 'string',
                'group'             => 'Parameters',
            ],
            'channelSlug' => [
                'title'             => 'voice.forum::lang.embedch.channel_title',
                'description'       => 'voice.forum::lang.embedch.channel_desc',
                'type'              => 'dropdown'
            ],
            'topicSlug' => [
                'title'             => 'voice.forum::lang.embedch.topic_name',
                'description'       => 'voice.forum::lang.embedch.topic_desc',
                'type'              => 'string',
                'default'           => '{{ :topicSlug }}',
                'group'             => 'Parameters',
            ],
    ...
    public function init()
    {
         ...
         */
            ...
            $component = $this->addComponent('Voice\Forum\Components\Channel', $this->alias, $properties);
