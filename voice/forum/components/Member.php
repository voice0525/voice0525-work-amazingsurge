...
class Member extends ComponentBase
{
    ...
    /**
     * @var Voice\Forum\Models\Member Other member cache
     */
    ...
    {
        return [
            'name'        => 'voice.forum::lang.memberpage.name',
            'description' => 'voice.forum::lang.memberpage.self_desc'
        ];
    }
    ...
    public function defineProperties()
    {
        return [
            'slug' => [
                'title'       => 'voice.forum::lang.memberpage.slug_name',
                'description' => 'voice.forum::lang.memberpage.slug_desc',
                'default'     => '{{ :slug }}',
                'type'        => 'string'
            ],
            'viewMode' => [
                'title'       => 'voice.forum::lang.memberpage.view_title',
                'description' => 'voice.forum::lang.memberpage.view_desc',
                'type'        => 'dropdown',
                'default'     => ''
            ],
            'channelPage' => [
                'title'       => 'voice.forum::lang.memberpage.ch_title',
                'description' => 'voice.forum::lang.memberpage.ch_desc',
                'type'        => 'dropdown',
                'group'       => 'Links',
            ],
            'topicPage' => [
                'title'       => 'voice.forum::lang.memberpage.topic_title',
                'description' => 'voice.forum::lang.memberpage.topic_desc',
                'type'        => 'dropdown',
                'group'       => 'Links',
            ],
        ];
    ...
    {
        return ['topic_reply' => 'voice.forum::mail.topic_reply'];
    }
    ...
    public function onReport()
    {
        ...
        if ($moderators) {
            ...
            Mail::sendTo($moderators, 'voice.forum::mail.member_report', $params);
        }
