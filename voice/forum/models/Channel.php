...
class Channel extends Model
{
     ...
     */
    public $hasMany = [
        'topics' => ['Voice\Forum\Models\Topic'],
    ];
     ...
     */
    public $hasOne = [
        'first_topic' => ['Voice\Forum\Models\Topic', 'order' => 'updated_at desc'],
    ];

    public $belongsToMany = [
        'categories' => ['Voice\Forum\Models\Category', 'table' => 'rainlab_forum_channels_categories']
    ];
